...
{
    public partial class SaksakCustomControl : UserControl
    {
        public SaksakCustomControl()
        {
            InitializeComponent();

            dgvSaksak.ColumnHeadersDefaultCellStyle.BackColor = Color.Gold;
            dgvSaksak.EnableHeadersVisualStyles = false;
        }
        ...
        private void btnForm_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start(@"C:\Documents\WaterApplicationFormSaksak.xls");
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Saksak Form Information!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void btnUserAgreement_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Saksak User Agreement Information!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }

        SaksakBLL s = new SaksakBLL();
        SaksakDAL dal = new SaksakDAL();
        int id = 1;
        ...
        private bool ValidateForm()
        {
            ...
            {
                errorProviderSaksak.SetError(txtCustomerCode, "Required Customer Code");
                bStatus = false;
            }
            else if (txtName.Text == "")
            {
                errorProviderSaksak.SetError(txtName, "Required Name");
                bStatus = false;
            }
            else if (txtMeterNumber.Text == "")
            {
                errorProviderSaksak.SetError(txtMeterNumber, "Required Meter Number");
                bStatus = false;
            }
            else if (cmbBoxStatus.Text == "Status")
            {
                errorProviderSaksak.SetError(cmbBoxStatus, "Required Status");
                bStatus = false;
            }
            else
            {
        ...
        private void dgvSaksak_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                foreach (DataGridViewRow row in dgvSaksak.Rows)
                {
        ...
        private void txtCurrentReading_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                errorProviderSaksak.SetError(txtCurrentReading, "Please enter only numbers.");
            }
        }
        ...
        private void txtLessCubicMeter_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                errorProviderSaksak.SetError(txtLessCubicMeter, "Please enter only numbers.");
            }
        }
        ...
        private void txtPreviousReading_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                errorProviderSaksak.SetError(txtPreviousReading, "Please enter only numbers.");
            }
        }
        ...
        private void txtAmountPerCubicMeter_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                errorProviderSaksak.SetError(txtAmountPerCubicMeter, "Please enter only numbers.");
            }
        }

        private void SaksakCustomControl_Load(object sender, EventArgs e)
        {
            ...
            dgvSaksak.Columns[0].Visible = false;
        ...
        private void dgvSaksak_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            try
            {
                if (dgvSaksak.Rows[e.RowIndex].Cells["Status"].Value.ToString() == "Disconnection")
                {
                    e.CellStyle.BackColor = Color.Red;
                }
                else if (dgvSaksak.Rows[e.RowIndex].Cells["Status"].Value.ToString() == "Penalty/Warning")
                {
                    e.CellStyle.BackColor = Color.Olive;
                }
                else if (dgvSaksak.Rows[e.RowIndex].Cells["Status"].Value.ToString() == "Government")
                {
                    e.CellStyle.BackColor = Color.Magenta;
                }
                else if (dgvSaksak.Rows[e.RowIndex].Cells["Status"].Value.ToString() == "PriorityLessCBM")
                {
            ...
            {
                MessageBox.Show(ex.Message, "DataGridView Saksak CellFormatting Information!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            ...
            var column = dgvSaksak.Columns[e.ColumnIndex];
            if (column.Name == "Bill")
            {
                var cell = dgvSaksak.Rows[e.RowIndex].Cells[e.ColumnIndex];
        ...
        private void dgvSaksak_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            // Get the index of particular row
            int rowIndex = e.RowIndex;
            id = Convert.ToInt32(dgvSaksak.Rows[rowIndex].Cells[0].Value.ToString());
            txtCustomerCode.Text = dgvSaksak.Rows[rowIndex].Cells[1].Value.ToString();
            txtName.Text = dgvSaksak.Rows[rowIndex].Cells[2].Value.ToString();
            txtMeterNumber.Text = dgvSaksak.Rows[rowIndex].Cells[3].Value.ToString();
            txtCurrentReading.Text = dgvSaksak.Rows[rowIndex].Cells[4].Value.ToString();
            txtPreviousReading.Text = dgvSaksak.Rows[rowIndex].Cells[5].Value.ToString();
            txtConsume.Text = dgvSaksak.Rows[rowIndex].Cells[6].Value.ToString();
            txtLessCubicMeter.Text = dgvSaksak.Rows[rowIndex].Cells[7].Value.ToString();
            txtTotalCBM.Text = dgvSaksak.Rows[rowIndex].Cells[8].Value.ToString();
            txtAmountPerCubicMeter.Text = dgvSaksak.Rows[rowIndex].Cells[9].Value.ToString();
            txtCurrentBill.Text = dgvSaksak.Rows[rowIndex].Cells[10].Value.ToString();
            txtPreviousBalance.Text = dgvSaksak.Rows[rowIndex].Cells[11].Value.ToString();
            txtAmountPaid.Text = dgvSaksak.Rows[rowIndex].Cells[12].Value.ToString();
            txtDatePaid.Text = dgvSaksak.Rows[rowIndex].Cells[13].Value.ToString();
            txtORNo.Text = dgvSaksak.Rows[rowIndex].Cells[14].Value.ToString();
            txtBalance.Text = dgvSaksak.Rows[rowIndex].Cells[15].Value.ToString();
            cmbBoxStatus.Text = dgvSaksak.Rows[rowIndex].Cells[16].Value.ToString();
            txtOtherInformation.Text = dgvSaksak.Rows[rowIndex].Cells[18].Value.ToString();
            ...
            this.dgvSaksak.Size = new System.Drawing.Size(1123, 290);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (ValidateForm())
            {
                ...
                s.CustomerID = txtCustomerCode.Text;
                s.Name = txtName.Text;
                s.Meter_No = txtMeterNumber.Text;
                s.Current_ = current;
                s.Previous = previous;
                //s.Consumed = Convert.ToInt32(txtConsumed.Text); Read only
                s.LessCBM = lessCubicMeter; // 5 cubic
                //s.Total_Cubic_Meter = Convert.ToInt32(txtTotalCubicMeter.Text); Read only
                s.AmountPerCBM = amountPerCubicMeter; // 15 pesos
                //s.Current_Bill = Convert.ToDecimal(txtCurrentBill.Text); Read only
                s.PreviousBalance = txtPreviousBalance.Text;
                s.AmountPaid = txtAmountPaid.Text;
                s.DatePaid = txtDatePaid.Text;
                s.OR_No = txtORNo.Text;
                s.Balance = txtBalance.Text;
                s.Status = cmbBoxStatus.Text;
                s.Added_Date = DateTime.Now;
                s.OtherInformation = txtOtherInformation.Text;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            s.Name = txtName.Text;
            s.Meter_No = txtMeterNumber.Text;
            s.Current_ = Convert.ToInt32(txtCurrentReading.Text);
            s.Previous = Convert.ToInt32(txtPreviousReading.Text);
            s.LessCBM = Convert.ToInt32(txtLessCubicMeter.Text);
            s.AmountPerCBM = Convert.ToDecimal(txtAmountPerCubicMeter.Text);
            s.PreviousBalance = txtPreviousBalance.Text;
            s.AmountPaid = txtAmountPaid.Text;
            s.DatePaid = txtDatePaid.Text;
            s.OR_No = txtORNo.Text;
            ...
            if (DialogResult.Yes == MessageBox.Show("Are you sure want to transfer value from Current Reading to Previous Reading?", "Transfer Information!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(@"UPDATE tbl_Saksak SET CustomerID=@CustomerID, Name=@Name, Meter_No=@Meter_No, Current_=@Current, Previous=@Previous, Consume=@Consume, LessCBM=@LessCBM, TotalCBM=@TotalCBM, AmountPerCBM=@AmountPerCBM, Bill=@Bill, PreviousBalance=@PreviousBalance, AmountPaid=@AmountPaid, DatePaid=@DatePaid, OR_No=@OR_No, Balance=@Balance, Status=@Status, Added_Date=@Added_Date, OtherInformation=@OtherInformation WHERE ID=@ID", conn))
                {
                    ...
                    using (SqlTransaction tr = conn.BeginTransaction())
                    {
                        ...
                        foreach (DataGridViewRow item in dgvSaksak.Rows)
                        {
        ...
        {
            frmPrintReadingSaksak frm = new frmPrintReadingSaksak(DateTime.Now.ToString("MMMM - yyyy"), string.Format("{0}", txtTotalMembers.Text));
            frm.Show();
        }
        ...
        private void btnPaymentForTreasurer_Click(object sender, EventArgs e)
        {
            if (checkBoxLastMonthPrintPayment.Checked)
            {
                ...
                frmPrintPaymentSaksak frm = new frmPrintPaymentSaksak(lastMonth.ToString("MMMM - yyyy"), string.Format("{0}", txtTotalMembers.Text));
                frm.Show();
            }
            else
            {
                frmPrintPaymentSaksak frm = new frmPrintPaymentSaksak(DateTime.Now.ToString("MMMM - yyyy"), string.Format("{0}", txtTotalMembers.Text));
                frm.Show();
            }
        }
        ...
        {
            this.dgvSaksak.Size = new System.Drawing.Size(1123, 459);
