...
{
    public partial class frmPrintReceiptKantabogon : Form
    {
        string _name, _current, _previous, _date, _bill, _consume, _lessCBM, _totalCBM, _amountPerCBM;

        public frmPrintReceiptKantabogon(string name, string current, string previous, string date, string bill, string consume, string lessCBM, string totalCBM, string amountPerCBM)
        {
            InitializeComponent();
            _name = name;
            _current = current;
        ...
        private void frnPrintReceiptKantabogon_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewerPrintReceiptKantabogon.LocalReport.SetParameters(para);
            this.reportViewerPrintReceiptKantabogon.RefreshReport();
        }
    }
}
