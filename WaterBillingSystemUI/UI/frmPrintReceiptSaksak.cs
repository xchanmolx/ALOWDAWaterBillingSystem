...
{
    public partial class frmPrintReceiptSaksak : Form
    {
        string _name, _current, _previous, _date, _bill, _consume, _lessCBM, _totalCBM, _amountPerCBM;

        public frmPrintReceiptSaksak(string name, string current, string previous, string date, string bill, string consume, string lessCBM, string totalCBM, string amountPerCBM)
        {
            InitializeComponent();
            _name = name;
            _current = current;
        ...
        private void frmPrintReceiptSaksak_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewerPrintReceiptSaksak.LocalReport.SetParameters(para);
            this.reportViewerPrintReceiptSaksak.RefreshReport();
        }
    }
}
