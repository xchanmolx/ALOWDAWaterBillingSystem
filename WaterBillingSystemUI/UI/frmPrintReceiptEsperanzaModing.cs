...
{
    public partial class frmPrintReceiptEsperanzaModing : Form
    {
        string _name, _current, _previous, _date, _bill, _consume, _lessCBM, _totalCBM, _amountPerCBM;

        public frmPrintReceiptEsperanzaModing(string name, string current, string previous, string date, string bill, string consume, string lessCBM, string totalCBM, string amountPerCBM)
        {
            InitializeComponent();
            _name = name;
            _current = current;
        ...
        private void frmPrintReceiptEsperanzaModing_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewerPrintReceiptEsperanzaModing.LocalReport.SetParameters(para);
            this.reportViewerPrintReceiptEsperanzaModing.RefreshReport();
        }
    }
}
