...
{
    public partial class frmPrintReceiptPoblacionKanlagono : Form
    {
        string _name, _current, _previous, _date, _bill, _consume, _lessCBM, _totalCBM, _amountPerCBM;

        public frmPrintReceiptPoblacionKanlagono(string name, string current, string previous, string date, string bill, string consume, string lessCBM, string totalCBM, string amountPerCBM)
        {
            InitializeComponent();
            _name = name;
            _current = current;
        ...
        private void frmPrintReceiptPoblacionKanlagono_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewerPrintReceiptPoblacionKanlagono.LocalReport.SetParameters(para);
            this.reportViewerPrintReceiptPoblacionKanlagono.RefreshReport();
        }
    }
}
