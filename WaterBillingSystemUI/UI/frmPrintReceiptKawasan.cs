...
{
    public partial class frmPrintReceiptKawasan : Form
    {
        string _name, _current, _previous, _date, _bill, _consume, _lessCBM, _totalCBM, _amountPerCBM;

        public frmPrintReceiptKawasan(string name, string current, string previous, string date, string bill, string consume, string lessCBM, string totalCBM, string amountPerCBM)
        {
            InitializeComponent();
            _name = name;
            _current = current;
        ...
        private void frmPrintReceiptKawasan_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewerPrintReceiptKawasan.LocalReport.SetParameters(para);
            this.reportViewerPrintReceiptKawasan.RefreshReport();
        }
    }
}
