...
{
    public partial class frmPrintReceiptOlangoEsperanza : Form
    {
        string _name, _current, _previous, _date, _bill, _consume, _lessCBM, _totalCBM, _amountPerCBM;

        public frmPrintReceiptOlangoEsperanza(string name, string current, string previous, string date, string bill, string consume, string lessCBM, string totalCBM, string amountPerCBM)
        {
            InitializeComponent();
            _name = name;
            _current = current;
        ...
        private void frmPrintReceiptOlangoEsperanza_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewerPrintReceiptOlangoEsperanza.LocalReport.SetParameters(para);
            this.reportViewerPrintReceiptOlangoEsperanza.RefreshReport();
        }
    }
}
