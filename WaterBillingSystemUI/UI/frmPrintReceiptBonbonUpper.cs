...
{
    public partial class frmPrintReceiptBonbonUpper : Form
    {
        string _name, _current, _previous, _date, _bill, _consume, _lessCBM, _totalCBM, _amountPerCBM;

        public frmPrintReceiptBonbonUpper(string name, string current, string previous, string date, string bill, string consume, string lessCBM, string totalCBM, string amountPerCBM)
        {
            InitializeComponent();
            _name = name;
            _current = current;
        ...
        private void frmPrintReceiptBonbonUpper_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewerPrintReceiptBonbonUpper.LocalReport.SetParameters(para);
            this.reportViewerPrintReceiptBonbonUpper.RefreshReport();
        }
    }
}
