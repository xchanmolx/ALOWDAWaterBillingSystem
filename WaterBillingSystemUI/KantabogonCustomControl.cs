...
{
    public partial class KantabogonCustomControl : UserControl
    {
        public KantabogonCustomControl()
        {
            InitializeComponent();

            dgvKantabogon.ColumnHeadersDefaultCellStyle.BackColor = Color.Gold;
            dgvKantabogon.EnableHeadersVisualStyles = false;
        }
        ...
        private void btnForm_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start(@"C:\Documents\WaterApplicationFormKantabogon.xls");
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Kantabogon Form Information!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void btnUserAgreement_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Kantabogon User Agreement Information!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }

        KantabogonBLL k = new KantabogonBLL();
        KantabogonDAL dal = new KantabogonDAL();
        int id = 1;
        ...
        private bool ValidateForm()
        {
            ...
            {
                errorProviderKantabogon.SetError(txtCustomerCode, "Required Customer Code");
                bStatus = false;
            }
            else if (txtName.Text == "")
            {
                errorProviderKantabogon.SetError(txtName, "Required Name");
                bStatus = false;
            }
            else if (txtMeterNumber.Text == "")
            {
                errorProviderKantabogon.SetError(txtMeterNumber, "Required Meter Number");
                bStatus = false;
            }
            else if (cmbBoxStatus.Text == "Status")
            {
                errorProviderKantabogon.SetError(cmbBoxStatus, "Required Status");
                bStatus = false;
            }
            else
            {
        ...
        private void dgvKantabogon_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                foreach (DataGridViewRow row in dgvKantabogon.Rows)
                {
        ...
        private void txtCurrentReading_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                errorProviderKantabogon.SetError(txtCurrentReading, "Please enter only numbers.");
            }
        }
        ...
        private void txtLessCubicMeter_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                errorProviderKantabogon.SetError(txtLessCubicMeter, "Please enter only numbers.");
            }
        }
        ...
        private void txtPreviousReading_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                errorProviderKantabogon.SetError(txtPreviousReading, "Please enter only numbers.");
            }
        }
        ...
        private void txtAmountPerCubicMeter_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                errorProviderKantabogon.SetError(txtAmountPerCubicMeter, "Please enter only numbers.");
            }
        }

        private void KantabogonCustomControl_Load(object sender, EventArgs e)
        {
            ...
            dgvKantabogon.Columns[0].Visible = false;
        ...
        private void dgvKantabogon_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            try
            {
                if (dgvKantabogon.Rows[e.RowIndex].Cells["Status"].Value.ToString() == "Disconnection")
                {
                    e.CellStyle.BackColor = Color.Red;
                }
                else if (dgvKantabogon.Rows[e.RowIndex].Cells["Status"].Value.ToString() == "Penalty/Warning")
                {
                    e.CellStyle.BackColor = Color.Olive;
                }
                else if (dgvKantabogon.Rows[e.RowIndex].Cells["Status"].Value.ToString() == "Government")
                {
                    e.CellStyle.BackColor = Color.Magenta;
                }
                else if (dgvKantabogon.Rows[e.RowIndex].Cells["Status"].Value.ToString() == "PriorityLessCBM")
                {
            ...
            {
                MessageBox.Show(ex.Message, "DataGridView Kantabogon CellFormatting Information!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            ...
            var column = dgvKantabogon.Columns[e.ColumnIndex];
            if (column.Name == "Bill")
            {
                var cell = dgvKantabogon.Rows[e.RowIndex].Cells[e.ColumnIndex];
        ...
        private void dgvKantabogon_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            // Get the index of particular row
            int rowIndex = e.RowIndex;
            id = Convert.ToInt32(dgvKantabogon.Rows[rowIndex].Cells[0].Value.ToString());
            txtCustomerCode.Text = dgvKantabogon.Rows[rowIndex].Cells[1].Value.ToString();
            txtName.Text = dgvKantabogon.Rows[rowIndex].Cells[2].Value.ToString();
            txtMeterNumber.Text = dgvKantabogon.Rows[rowIndex].Cells[3].Value.ToString();
            txtCurrentReading.Text = dgvKantabogon.Rows[rowIndex].Cells[4].Value.ToString();
            txtPreviousReading.Text = dgvKantabogon.Rows[rowIndex].Cells[5].Value.ToString();
            txtConsume.Text = dgvKantabogon.Rows[rowIndex].Cells[6].Value.ToString();
            txtLessCubicMeter.Text = dgvKantabogon.Rows[rowIndex].Cells[7].Value.ToString();
            txtTotalCBM.Text = dgvKantabogon.Rows[rowIndex].Cells[8].Value.ToString();
            txtAmountPerCubicMeter.Text = dgvKantabogon.Rows[rowIndex].Cells[9].Value.ToString();
            txtCurrentBill.Text = dgvKantabogon.Rows[rowIndex].Cells[10].Value.ToString();
            txtPreviousBalance.Text = dgvKantabogon.Rows[rowIndex].Cells[11].Value.ToString();
            txtAmountPaid.Text = dgvKantabogon.Rows[rowIndex].Cells[12].Value.ToString();
            txtDatePaid.Text = dgvKantabogon.Rows[rowIndex].Cells[13].Value.ToString();
            txtORNo.Text = dgvKantabogon.Rows[rowIndex].Cells[14].Value.ToString();
            txtBalance.Text = dgvKantabogon.Rows[rowIndex].Cells[15].Value.ToString();
            cmbBoxStatus.Text = dgvKantabogon.Rows[rowIndex].Cells[16].Value.ToString();
            txtOtherInformation.Text = dgvKantabogon.Rows[rowIndex].Cells[18].Value.ToString();
            ...
            this.dgvKantabogon.Size = new System.Drawing.Size(1123, 305);
        }
            ...
            if (DialogResult.Yes == MessageBox.Show("Are you sure want to transfer value from Current Reading to Previous Reading?", "Transfer Information!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(@"UPDATE tbl_Kantabogon SET CustomerID=@CustomerID, Name=@Name, Meter_No=@Meter_No, Current_=@Current, Previous=@Previous, Consume=@Consume, LessCBM=@LessCBM, TotalCBM=@TotalCBM, AmountPerCBM=@AmountPerCBM, Bill=@Bill, PreviousBalance=@PreviousBalance, AmountPaid=@AmountPaid, DatePaid=@DatePaid, OR_No=@OR_No, Balance=@Balance, Status=@Status, Added_Date=@Added_Date, OtherInformation=@OtherInformation WHERE ID=@ID", conn))
                {
                    ...
                    using (SqlTransaction tr = conn.BeginTransaction())
                    {
                        ...
                        foreach (DataGridViewRow item in dgvKantabogon.Rows)
                        {
        ...
        {
            frmPrintReadingKantabogon frm = new frmPrintReadingKantabogon(DateTime.Now.ToString("MMMM - yyyy"), string.Format("{0}", txtTotalMembers.Text));
            frm.Show();
        }
        ...
        private void btnPaymentForTreasurer_Click(object sender, EventArgs e)
        {
            if (checkBoxLastMonthPrintPayment.Checked)
            {
                ...
                frmPrintPaymentKantabogon frm = new frmPrintPaymentKantabogon(lastMonth.ToString("MMMM - yyyy"), string.Format("{0}", txtTotalMembers.Text));
                frm.Show();
            }
            else
            {
                frmPrintPaymentKantabogon frm = new frmPrintPaymentKantabogon(DateTime.Now.ToString("MMMM - yyyy"), string.Format("{0}", txtTotalMembers.Text));
                frm.Show();
            }
        }
        ...
        {
            this.dgvKantabogon.Size = new System.Drawing.Size(1123, 459);
