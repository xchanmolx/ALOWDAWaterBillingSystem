    ...
    public class SaksakDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tbl_Saksak";
        ...
        public bool Insert(SaksakBLL s)
        {
            ...
            try
            {
                string sql = "INSERT INTO tbl_Saksak (CustomerID, Name, Meter_No, Current_, Previous, Consume, LessCBM, TotalCBM, AmountPerCBM, Bill, PreviousBalance, AmountPaid, DatePaid, OR_No, Balance, Status, Added_Date, OtherInformation) VALUES (@CustomerID, @Name, @Meter_No, @Current, @Previous, @Consume, @LessCBM, @TotalCBM, @AmountPerCBM, @Bill, @PreviousBalance, @AmountPaid, @DatePaid, @OR_No, @Balance, @Status, @Added_Date, @OtherInformation)";
                SqlCommand cmd = new SqlCommand(sql, conn);

                cmd.Parameters.AddWithValue("@CustomerID", s.CustomerID);
                cmd.Parameters.AddWithValue("@Name", s.Name);
                cmd.Parameters.AddWithValue("@Meter_No", s.Meter_No);
                cmd.Parameters.AddWithValue("@Current", s.Current_);
                cmd.Parameters.AddWithValue("@Previous", s.Previous);
                cmd.Parameters.AddWithValue("@Consume", s.Consume);
                cmd.Parameters.AddWithValue("@LessCBM", s.LessCBM);
                cmd.Parameters.AddWithValue("@TotalCBM", s.TotalCBM);
                cmd.Parameters.AddWithValue("@AmountPerCBM", s.AmountPerCBM);
                cmd.Parameters.AddWithValue("@Bill", s.Bill);
                cmd.Parameters.AddWithValue("@PreviousBalance", s.PreviousBalance);
                cmd.Parameters.AddWithValue("@AmountPaid", s.AmountPaid);
                cmd.Parameters.AddWithValue("@DatePaid", s.DatePaid);
                cmd.Parameters.AddWithValue("@OR_No", s.OR_No);
                cmd.Parameters.AddWithValue("@Balance", s.Balance);
                cmd.Parameters.AddWithValue("@Status", s.Status);
                cmd.Parameters.AddWithValue("@Added_Date", s.Added_Date);
                cmd.Parameters.AddWithValue("@OtherInformation", s.OtherInformation);
        ...
        public bool Update(SaksakBLL s)
        {
            bool isSuccess = false;
            SqlConnection conn = new SqlConnection(UserDAL.myconnstrng);
        ...
        public bool Delete(SaksakBLL s)
        {
            bool isSuccess = false;
            SqlConnection conn = new SqlConnection(UserDAL.myconnstrng);
            ...
            try
            {
                string sql = "DELETE FROM tbl_Saksak WHERE ID=@ID";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM tbl_Saksak WHERE CustomerID LIKE '%" + keywords + "%' OR Name LIKE '%" + keywords + "%' OR Meter_No LIKE '%" + keywords + "%' OR Status LIKE '%" + keywords + "%' ";
