    ...
    public class AngilanDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tbl_Angilan";
        ...
        public bool Insert(AngilanBLL a)
        {
            ...
            try
            {
                string sql = "INSERT INTO tbl_Angilan (CustomerID, Name, Meter_No, Current_, Previous, Consume, LessCBM, TotalCBM, AmountPerCBM, Bill, PreviousBalance, AmountPaid, DatePaid, OR_No, Balance, Status, Added_Date, OtherInformation) VALUES (@CustomerID, @Name, @Meter_No, @Current, @Previous, @Consume, @LessCBM, @TotalCBM, @AmountPerCBM, @Bill, @PreviousBalance, @AmountPaid, @DatePaid, @OR_No, @Balance, @Status, @Added_Date, @OtherInformation)";
                SqlCommand cmd = new SqlCommand(sql, conn);
                ...
                cmd.Parameters.AddWithValue("@LessCBM", a.LessCBM);
                cmd.Parameters.AddWithValue("@TotalCBM", a.TotalCBM);
                cmd.Parameters.AddWithValue("@AmountPerCBM", a.AmountPerCBM);
                cmd.Parameters.AddWithValue("@Bill", a.Bill);
                ...
                cmd.Parameters.AddWithValue("@OR_No", a.OR_No);
        ...
        public bool Update(AngilanBLL a)
        {
            bool isSuccess = false;
            SqlConnection conn = new SqlConnection(UserDAL.myconnstrng);
        ...
        public bool Delete(AngilanBLL a)
        {
            bool isSuccess = false;
            SqlConnection conn = new SqlConnection(UserDAL.myconnstrng);
            ...
            try
            {
                string sql = "DELETE FROM tbl_Angilan WHERE ID=@ID";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM tbl_Angilan WHERE CustomerID LIKE '%" + keywords + "%' OR Name LIKE '%" + keywords + "%' OR Meter_No LIKE '%" + keywords + "%' OR Status LIKE '%" + keywords + "%' ";
