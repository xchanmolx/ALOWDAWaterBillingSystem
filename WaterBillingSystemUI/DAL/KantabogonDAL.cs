    ...
    public class KantabogonDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tbl_Kantabogon";
        ...
        public bool Insert(KantabogonBLL k)
        {
            ...
            try
            {
                string sql = "INSERT INTO tbl_Kantabogon (CustomerID, Name, Meter_No, Current_, Previous, Consume, LessCBM, TotalCBM, AmountPerCBM, Bill, PreviousBalance, AmountPaid, DatePaid, OR_No, Balance, Status, Added_Date, OtherInformation) VALUES (@CustomerID, @Name, @Meter_No, @Current, @Previous, @Consume, @LessCBM, @TotalCBM, @AmountPerCBM, @Bill, @PreviousBalance, @AmountPaid, @DatePaid, @OR_No, @Balance, @Status, @Added_Date, @OtherInformation)";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public bool Update(KantabogonBLL k)
        {
            bool isSuccess = false;
            SqlConnection conn = new SqlConnection(UserDAL.myconnstrng);
        ...
        public bool Delete(KantabogonBLL k)
        {
            bool isSuccess = false;
            SqlConnection conn = new SqlConnection(UserDAL.myconnstrng);
            ...
            try
            {
                string sql = "DELETE FROM tbl_Kantabogon WHERE ID=@ID";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM tbl_Kantabogon WHERE CustomerID LIKE '%" + keywords + "%' OR Name LIKE '%" + keywords + "%' OR Meter_No LIKE '%" + keywords + "%' OR Status LIKE '%" + keywords + "%' ";
